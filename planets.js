...
function planetMercury() {
  const newImageUrl = "imgs/planets/mercury.png"
  resetAnimation()
...
function planetVenus() {
  const newImageUrl = "imgs/planets/venus.png"
  resetAnimation()
...
function planetEarth() {
  const newImageUrl = "imgs/planets/earth.png"
  resetAnimation()
...
function planetMars() {
  const newImageUrl = "imgs/planets/mars.png"
  resetAnimation()
...
function planetJupiter() {
  const newImageUrl = "imgs/planets/jupiter.png"
  resetAnimation()
...
function planetSaturn() {
  const newImageUrl = "imgs/planets/saturn.png"
  resetAnimation()
...
function planetUranus() {
  const newImageUrl = "imgs/planets/uranus.png"
  resetAnimation()
...
function planetNeptune() {
  const newImageUrl = "imgs/planets/neptune.png"
  resetAnimation()
